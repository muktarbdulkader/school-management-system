...
export const getStudentPortalMenu = () => {
  ...
  return {
    ...
    children: [
      ...
      { id: 'student-report-card', title: 'My Report Card', type: 'item', url: '/academic-reports/student', icon: IconCertificate, breadcrumbs: false },
