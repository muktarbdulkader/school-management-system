...
import { TextField, Button, MenuItem, Dialog, DialogActions, DialogContent, DialogTitle, Box, useTheme } from '@mui/material';
        ...
        <DialogContent>
          <form onSubmit={formik.handleSubmit}>
            ...
            <DialogActions>
              ...
              <DrogaButton
                type="submit"
                title={isAdding ? <ActivityIndicator size={18} sx={{ color: 'white' }} /> : 'Done'}
                sx={{ paddingX: 6 }}
              />
            </DialogActions>
          </form>
