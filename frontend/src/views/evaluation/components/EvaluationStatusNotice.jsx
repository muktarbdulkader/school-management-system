...
import evaluation from '../../../assets/images/evaluation-illustration.svg';
import PropTypes from 'prop-types';

const EvaluationStatusNotice = ({ status, changingStatus, onAccept, onOpenToDiscussion, onEsclate }) => {
          ...
          <Grid container spacing={gridSpacing} sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              ...
              <Box sx={{ marginY: 2 }}>
                <Typography variant="h1" color={theme.palette.text.primary} sx={{ marginY: 1.2 }}>
                  Your performance evaluation of this year is sent to you
                </Typography>

                <Typography variant="body2" color={theme.palette.text.primary}>
                  Take a look at each KPI evaluations and take action accordingly
                </Typography>
              </Box>
            ...
            {bigDevice && (
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                <img src={evaluation} alt="Plans" style={{ width: '70%', height: '70%', objectPosition:'right' }} />
              </Grid>
            )}
          </Grid>
        </Grid>
...
EvaluationStatusNotice.propTypes = {
  status: PropTypes.string,
  onAccept: PropTypes.func,
  onOpenToDiscussion: PropTypes.func,
  onEsclate: PropTypes.func
};
export default EvaluationStatusNotice;
