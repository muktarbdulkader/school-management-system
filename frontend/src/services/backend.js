...
const Backend = {
  ...
  teacherRatingsMy: 'teacher-ratings/my-ratings/',
  ...
  performanceEvaluationSettings: 'performance-criteria/evaluation-settings/',
  performanceEvaluationSetPeriod: 'performance-criteria/set-evaluation-period/',
  performanceAllEvaluations: 'performance-criteria/all-evaluations/',
